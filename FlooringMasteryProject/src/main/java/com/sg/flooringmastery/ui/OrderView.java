...
//        return io.readDate("Please enter the date (MM-DD-YYYY)" , LocalDate.of(2021,12,15), LocalDate.of(2030,12,31));
//    }
//    
...
//    }
//    
//    public String inputStateAbbrev(){
//        return io.readString("Please enter your State's USPS abbreviation:");
//    }
//    
//    public String inputProductType(){
//        return io.readString("Please enter the product you will be using", 1, 15);
//    }
//    
...
//        for (Order ordr : ordersByDate){
//            io.print(ordr.getOrderNumber() + " | " + ordr.getCustomerName() + " | "
//            + io.formatCurrency(ordr.getTotal()));
//        }
//        
//    }
...
//        ordr.setOrderDate(inputDate());
//        ordr.setCustomerName(inputCustomerName());
//        ordr.setState(inputStateAbbrev());
//        ordr.setProductType(inputProductType());
//        ordr.setArea(inputArea());
//        return ordr;
//    }
